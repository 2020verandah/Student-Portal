...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="col-lg-8 m-auto d-block">
            ...
            <asp:Button ID="Button_CancelLogIn" runat="server" type="button" name="cancel" class="btn btn-danger" Text="Cancel" OnClientClick="alert()" OnClick="Button_CancelLogIn_Click" />
