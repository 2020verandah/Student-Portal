...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <asp:GridView ID="grd_getallcourses" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" Width="452px">
     ...
     <SortedDescendingHeaderStyle BackColor="#242121" />
      ...
      <asp:Panel ID="pnl_getcourse" runat="server">
            <div>
                ...
                <asp:Label ID="Label1" runat="server" Text="Enter Course Id: "></asp:Label> <asp:TextBox ID="tbox_cid" runat="server"></asp:TextBox>
              &nbsp; &nbsp; &nbsp;
